...
- The Cloud Run runtime service account has Vertex AI User plus access to one GitHub App private-key secret. GitHub installation tokens are short lived and scoped to this repository.
